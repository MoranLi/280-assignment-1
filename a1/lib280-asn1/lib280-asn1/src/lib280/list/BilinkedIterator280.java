...
public class BilinkedIterator280<I> extends LinkedIterator280<I> implements BilinearIterator280<I>
{
	...
	{
		// TODO
		if(list.isEmpty()){ throw new ContainerEmpty280Exception("The object List is empty!"); }
		cur = list.lastNode();
	...
	{
		// TODO
		if(before()){ throw new BeforeTheStart280Exception("Can not go more before when it is already start of before list");}
		if(after()){goLast();}
		cur = prev;
